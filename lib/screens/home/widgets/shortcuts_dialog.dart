        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Semantics(header: true, child: Text(l10n.sectionLecteur, style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: tc.textSecondary))),
              ...
              const SizedBox(height: 16),
              Semantics(header: true, child: Text('${l10n.sectionLecteur} Live', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: tc.textSecondary))),
              Divider(color: tc.divider, height: 12),
