...
/// Slim AppBar for the player — just the channel-context badges (replay
/// / live / EPG / quality / next show) and the channel-zap arrows.
///
/// Audio / subtitle / aspect / speed / sleep-timer / deinterlace / mini-
/// player pickers used to live here too. They moved into the
/// Apple-TV+-style drawer (`CinematicControls`) so the top bar can stay
/// out of the way during playback.
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
      ...
      actions: <Widget>[
        ...
        if (isLiveMode && channelList) ...<Widget>[
          IconButton(
